 ...
 *
 * @param {BrowserInterface} browserInterface - interface to access pages
 * @param {Object} selectorPages - All the CSS selectors to URLs map object.
 * @param {string[]} validUrls - List of all the valid URLs
 * @param {Array} viewports - Browser viewports
 * @param {number} successUrlsThreshold - Success URLs amount threshold
 * @param {Function} updateProgress - Update progress callback function
